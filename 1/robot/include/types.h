...
struct Config {
    ...
    double target_speed_rate_limit = 6.0;
    double target_pitch_rate_limit_dps = 120.0;
    double target_displacement_catchup_rate = 0.8;
    double stop_speed_threshold_tps = 0.12;
    double stop_hold_capture_window_tps = 0.20;
    double reference_position_gain = 0.18;
    double reference_velocity_damping_gain = 0.10;
    double speed_to_pitch_ff = 2.0;
    double accel_to_pitch_ff = 0.25;
    ...
    double lqr_k_theta = 1.8;
    double lqr_k_theta_d = 0.08;
    double lqr_k_x = 0.24;
    double lqr_k_v = 0.45;
    ...
    void sanitize() {
        ...
        clampd(target_speed_rate_limit, 0.01, 1000.0); clampd(target_pitch_rate_limit_dps, 0.01, 5000.0); clampd(target_displacement_catchup_rate, 0.0, 100.0); clampd(stop_speed_threshold_tps, 0.0, 10.0); clampd(stop_hold_capture_window_tps, 0.0, 10.0); clampd(reference_position_gain, 0.0, 50.0); clampd(reference_velocity_damping_gain, 0.0, 50.0); clampd(speed_to_pitch_ff, -100.0, 100.0); clampd(accel_to_pitch_ff, -100.0, 100.0);
