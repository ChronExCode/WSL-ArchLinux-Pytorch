...
std::string TcpServer::telemetry_json(double pitch, double roll, double yaw,
    ...
    obj.add_number("tgt_pitch", pid_dbg.target_pitch); obj.add_number("actual_pitch", pid_dbg.actual_pitch); obj.add_number("flt_pitch", pid_dbg.filtered_pitch); obj.add_number("flt_pitch_rate", pid_dbg.filtered_pitch_rate); obj.add_number("pitch_err", pid_dbg.pitch_error);
    ...
    obj.add_number("tgt_speed", pid_dbg.target_speed); obj.add_number("spd_est", pid_dbg.speed_estimate); obj.add_number("flt_vel", pid_dbg.filtered_velocity); obj.add_number("spd_err", pid_dbg.speed_error);
    obj.add_number("ang_vel", pid_dbg.gyro_y); obj.add_number("ang_acc", pid_dbg.gyro_y_dot);
    obj.add_number("pos_l", pid_dbg.pos_left); obj.add_number("pos_r", pid_dbg.pos_right); obj.add_number("pos_disp", pid_dbg.pos_disp); obj.add_number("obs_disp", pid_dbg.observed_displacement); obj.add_number("pos_target", pid_dbg.pos_target); obj.add_number("pos_out", pid_dbg.pos_out);
