...
private:
    ...
    std::thread encoder_thread_;    // low-priority ODrive encoder polling
    ...
    /// Low-priority ODrive encoder polling loop; keeps blocking ASCII queries out of control_tick().
    void encoder_loop();
