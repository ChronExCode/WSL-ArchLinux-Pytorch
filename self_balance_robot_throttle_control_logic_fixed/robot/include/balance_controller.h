...
private:
    ...
    double auto_tune_scale_ = 1.0;
    double auto_tune_pitch_rms_ = 0.0;
    double auto_tune_speed_rms_ = 0.0;
    ...
    void update_auto_tune(const EstimatedState& state, const ReferenceState& ref, double dt);
    double friction_compensation(double base_velocity, const ReferenceState& ref, const EstimatedState& state) const;
